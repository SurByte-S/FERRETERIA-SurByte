-- Aplicar solo despues de backup/snapshot.
-- Proyecto remoto auditado: nufdzannftjgobxixxhz (Ferreteria).
-- Aplicacion manual preparada porque el remoto no tiene historial en supabase_migrations.schema_migrations.
-- No ejecutar con supabase db push hasta reparar/definir historial de migraciones.
-- Contenido: 026_products_custom_code.sql + 027_product_custom_code_search.sql + 028_backfill_product_custom_codes.sql.

begin;

-- ============================================================
-- 026_products_custom_code.sql
-- ============================================================
...
-- ============================================================
-- 027_product_custom_code_search.sql
-- ============================================================
...
-- ============================================================
-- 028_backfill_product_custom_codes.sql
-- ============================================================
do $$
declare
  generated_code text;
...
-- ============================================================
-- Consultas de verificacion post-aplicacion
-- Ejecutar despues de confirmar que el bloque anterior finalizo sin errores.
-- ============================================================
...
where table_schema = 'public'
  ...
  and column_name in ('sku', 'barcode', 'custom_code')
...
from public.products
where nullif(trim(custom_code), '') is not null
group by tenant_id, custom_code
having count(*) > 1;

select *
from public.product_custom_code_counters
order by tenant_id;
